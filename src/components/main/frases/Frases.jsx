    ...
    <section className="section-container frases">
      <div className="row">
        <div className="col-12">
            ...
            <h2 className="say1">
              <span data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1000">La distancia entre los sueños </span>
      ...
      <div className="row">
        <div className="col-12">
             <h2 className="say2">
               <span data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1000"> y la realidad </span>
      ...
      <div className="row">
        <div className="col-12">
            <h2 className="say3">
              <span data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000"  >se llama disciplina.</span>     
