  ...
  return (
    ...
    >
      <div className="holder container">
        <Navbar.Brand className="banner ms-5" title="Gimnasio Craneo">
          ...
          >
            <Nav className="navbar-nav">
              <li className="nav-item">
                <Nav.Link href="#cuota" className="button" title="Que hacemos">
                  PAGAR CUOTA
                </Nav.Link>
              </li>
              <li className="nav-item">
                <Nav.Link className="button logBtn" title="Logout" href="/">
                  LOGOUT
                </Nav.Link>
              </li>
              <Nav.Link
              ...
              <Nav.Link className="nav-item button">
                Nombre de usurario
              </Nav.Link>
            </Nav>
